...
- [done] `analyze` command, OpenAI analysis runtime, and canonical result bundles
...
- Conservative model routing and one bounded automatic recovery hop for
  implementation-mode runs only
...
| 04 | [Plan-04-analysis-runtime-and-model-routing.md](Plan-04-analysis-runtime-and-model-routing.md) | done | 03 | analysis runtime, routing, result bundles |
